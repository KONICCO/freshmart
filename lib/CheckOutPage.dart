                  ...
                  children: <Widget>[
                    RichText(
                        ...
                        text: TextSpan(children: [
                          TextSpan(
                            text:
                                "\n\nTerimakasih telah melakukan pemesanan pada perusahaan kami. Siapkan pembayaran saat kurir sampai di alamat anda!",
                            style: CustomTextStyle.textFormFieldMedium.copyWith(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              createAddressText("Jl. Wringin Kembar, Baratan, Jember", 16),
              createAddressText("Gg Paving Merah. 07", 6),
              SizedBox(
                height: 6,
              ),
              RichText(
        ...
        children: <Widget>[
          ...
          Column(
            ...
            children: <Widget>[
              ...
              Text(
                "Estimasi Pengiriman hari ini jam 13.00 wib | Free Delivery",
                style: CustomTextStyle.textFormFieldMedium.copyWith(
                  color: Colors.black,
                  fontSize: 12,
                ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              createPriceItem("Harga", "Rp 10.000", Colors.lightGreen),
              SizedBox(
                height: 8,
              ),
              Container(
